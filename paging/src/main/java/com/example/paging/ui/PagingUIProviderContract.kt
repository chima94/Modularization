...
interface PagingUIProviderContract {
    ...
    fun isLoadStateNoConnectionException(state : LoadState): Boolean = state is LoadState.Error
    ...
    fun isLoadStateError(state: LoadState): Boolean = state is LoadState.Error
}